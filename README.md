...
No build step. No dependencies. No runtime. Static HTML, CSS, vanilla ES
...
All three are zero-dependency Node scripts and must be run from this
directory.
...
what ships here are the three validators above, which are the checks a
